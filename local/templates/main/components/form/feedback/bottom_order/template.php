...
<form class="form" id="<?= $arParams["TOKEN"] ?>">
    <div class="form__line row">
        ...
        <div class="col-12 col-lg-6"><input class="form__input js--maskphone" type="text" name="PHONE" placeholder="Телефон" requared="requared" /></div>
        <div class="col-12 col-lg-6"><input class="form__input" type="text" name="EMAIL" placeholder="E-mail" requared="requared" /></div>
        <div class="col-12"><label class="form__textarea"><textarea class="js--form-textarea" name="MESSAGE"></textarea></label></div>
        <div class="col-12">
            <div class="form__info">Нажимая кнопку «Отправить», я&nbsp;даю согласие на&nbsp;обработку своих персональных данных в&nbsp;соответствии с&nbsp;<a href="/policy/">Политикой конфиденциальности</a></div>
        </div>
        <div class="col-12 col-xl-6">
        <button id="btn_<?= $arParams["TOKEN"] ?>" class="mbtn mbtn__primary mbtn__big d-block w-100" type="submit">Отправить</button>
