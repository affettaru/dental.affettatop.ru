...
<!-- <ul class="footer__menu__ul">
                                    <li class="footer__menu__item"><a class="footer__menu__link" href="#">Каталог товаров</a>
                                        <div class="footer__menu__sub">
                                            <ul>
                                                <li><a href="#">Импланты G-DIFF</a></li>
...
<li class="footer__menu__item">
    <? if ($curDir == $arItem["LINK"]): ?>
        <a class="footer__menu__link" href="<?= $arItem["LINK"] ?>"><?= $arItem["TEXT"] ?>
                                </a>                          
    <? else: ?>
        <a class="footer__menu__link" href="<?= $arItem["LINK"] ?>"><?= $arItem["TEXT"] ?>
        </a>
                            ...
                            <? if ($arItem["PERMISSION"] > "D"): ?>
                                ...
                                <? if ($arItem["DEPTH_LEVEL"] == 1): ?>
                                    <li class="footer__menu__item">
                                        ...
                                        <? else: ?>
                                            <a  class="footer__menu__link" href="<?= $arItem["LINK"] ?>"><span><?= $arItem["TEXT"] ?></span></a>
                                        <? endif ?>
                                    </li>
                                <? else: ?>
                                    <li>
