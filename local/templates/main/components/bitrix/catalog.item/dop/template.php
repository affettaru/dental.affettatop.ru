...
if (isset($arResult['ITEM']))
{
	...
	<div class="fullslider__slider__item w-card-catalog swiper-slide swiper-slide-active pcatalog__list__item col-12 col-sm-6 col-lg-4 catalog__el<?=(isset($arResult['SCALABLE']) && $arResult['SCALABLE'] === 'Y' ? ' product-item-scalable-card' : '')?>"
		...
		$arResult["ITEM"]["PREVIEW_PICTURE"] = $resize["src"];
		...
		$arResult["ITEM"]["DETAIL_PICTURE"] = $resize["src"];
