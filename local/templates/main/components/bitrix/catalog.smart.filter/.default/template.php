...
<!-- <div class="smart-filter mb-4 <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal"?>">
	<div class="smart-filter-section">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smart-filter-form">
			...
			<!-- <div class="row"> -->
						...
						<div class="filter__item">
                                        ...
                                        <div class="filter__slide js--filter-slide">
                                            <div class="filter__row row">
                                                <div class="col-6">
												<input
														class="min-price form-control form-control-sm form__input form__input__mini"
														type="number"
                                                ...
                                                <div class="col-6">
												<input
														class="max-price form-control form-control-sm form__input form__input__mini"
														type="number"
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<!-- <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> mb-2 smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<div class="filter__item">
                                        <div class="filter__title js--filter-title active"><span><?=$arItem["NAME"]?></span><i><svg>
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								<div class="filter__block__content js--filter-content">
										...
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											...
											<li><label class="form__check form__check__big">
												<input
													type="checkbox"
			...
			<!-- <div class="row"> -->
				<div class="col smart-filter-button-box filter__footer">
					<div class="smart-filter-block filter__row row">
						<!-- <div class="smart-filter-parameters-box-container"> -->
						<div class="col-12">
						<input
								class="mbtn mbtn__middle mbtn__grey d-block w-100"
								type="submit"
								id="del_filter"
								name="del_filter"
						...
						<div class="col-12">
							<input
								class="btn btn-primary mbtn mbtn__middle mbtn__primary d-block w-100"
								type="submit"
								id="set_filter"
								name="set_filter"
