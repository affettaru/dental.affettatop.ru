...
if(!$_GET["q"]) header("location: /catalog/");
 ...
 <div class="container">
	...
	Array(
		...
		"START_FROM" => "0"
             ...
             <?php
             $filter = ["%NAME" => $_GET["q"]];
             if($GLOBALS[$arParams["FILTER_NAME"]]) $GLOBALS[$arParams["FILTER_NAME"]] = array_merge($GLOBALS[$arParams["FILTER_NAME"]], $filter);
             else $GLOBALS[$arParams["FILTER_NAME"]] = $filter;?>
